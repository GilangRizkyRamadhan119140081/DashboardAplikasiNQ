                ...
                <form method="POST" action="{{ route('payment.update', $payment->id) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status" id="status" class="form-control" required>
                            ...
                            <option value="Completed"
                                {{ old('status', $payment->status) == 'Completed' ? 'selected' : '' }}>Completed</option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="quantity" id="quantity" class="form-control"
                            value="{{ old('quantity', $payment->quantity) }}" required>
                        @error('quantity')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="price" id="price" class="form-control"
                            value="{{ old('price', $payment->price) }}" required>
                        @error('price')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="item_name" id="item_name" class="form-control"
                            value="{{ old('item_name', $payment->item_name) }}" required>
                        @error('item_name')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" name="customer_email" id="customer_email" class="form-control"
                            value="{{ old('customer_email', $payment->customer_email) }}" required>
